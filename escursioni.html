    ...
    <section class="escursioni-list">
        <div class="container">
            ...
            <div class="escursione">
                <h3><a href="commenti-monte-bianco.html">Monte Bianco</a></h3>
                <p>Durata: 5 ore | Difficoltà: Alta</p>
                <p>Un'escursione impegnativa, ideale per chi cerca un'avventura ad alta quota.</p>
            </div>
            <div class="escursione">
                <h3><a href="commenti-gran-paradiso.html">Gran Paradiso</a></h3>
            ...
            <div class="escursione">
                <h3><a href="commenti-dolomiti.html">Dolomiti</a></h3>
